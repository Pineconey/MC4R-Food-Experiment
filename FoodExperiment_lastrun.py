...
expName = 'FoodExperiment'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\User\\OneDrive\\Documents\\UNI\\Work\\Yr 4\\Research Design in Neuro\\FoodExperiment_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('Order.xlsx'),
